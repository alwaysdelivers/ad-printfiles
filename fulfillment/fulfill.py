...
DAD_INK={'fullcolor':'split','full color':'split','split':'split','navy':'navy','red':'red','black':'black','white':'white','heathergrey':'grey','heather grey':'grey','grey':'grey','gray':'grey','karmablue':'karmablue','karma blue':'karmablue'}  # PDP Ink label -> print-file treatment key
...
AMERICA_INK={'navy':'navy','red':'red','black':'black','gold':'gold','white':'white','grey':'grey','heather grey':'grey','heathergrey':'grey','karmablue':'karmablue','karma blue':'karmablue','ice':'ice','ice blue':'ice','iceblue':'ice'}
