...
GOD_INK={'fullcolor':'split','full color':'split','split':'split','navy':'navy','red':'red','black':'black','heathergrey':'grey','heather grey':'grey','grey':'grey','gray':'grey','karmablue':'karmablue','karma blue':'karmablue','neon blue':'karmablue'}
GOD_VALID={'white':['navy','split','red','black','karmablue'],'athleticheather':['navy','split','red','black'],'navy':['grey'],'black':['red','grey','karmablue']}
GOD_DEFAULT={'white':'navy','athleticheather':'navy','navy':'grey','black':'grey'}  # cream culled
